...
{
    public class RepeaterItem : global::System.Web.UI.WebControls.RepeaterItem
    {
        public RepeaterItem(int itemIndex, ListItemType itemType) : base(itemIndex, itemType)
        { }
